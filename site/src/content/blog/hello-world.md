...
I also moved the domain from GoDaddy to Cloudflare, mostly because Cloudflare's dashboard is easier to live in. The DNS records moved over without drama, which is the nicest thing you can say about DNS.
